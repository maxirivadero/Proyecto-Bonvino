const bodegas = [
      ...
      },
      {
        ...
        "descripcion": "Una bodega con encanto, ubicada en un antiguo castillo restaurado.",
        "historia": "El Castillo es mucho más que una bodega: es un símbolo de la historia y la cultura de la región. Ubicada en un castillo del siglo XII cuidadosamente restaurado, esta bodega combina la tradición vinícola con la majestuosidad de su entorno.",
        "coordenadasUbicacion": [41.8369, -4.6910],
